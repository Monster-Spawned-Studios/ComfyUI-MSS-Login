...
def load_default_groups():
    ...
    if cfg is None:
        ...
        return {
            "admin": { "can_run": True, "can_upload": True, "can_access_manager": True, "can_access_api": True, "can_see_restricted_settings": True, "can_have_api_tokens": True, "can_have_non_expiring_jwt": True },
            "power": { "can_run": True, "can_upload": True, "can_access_manager": True, "can_access_api": True, "can_see_restricted_settings": False, "can_have_api_tokens": True, "can_have_non_expiring_jwt": False },
            "user": { "can_run": True, "can_upload": True, "can_access_manager": False, "can_access_api": True, "can_see_restricted_settings": False, "can_have_api_tokens": False, "can_have_non_expiring_jwt": False },
            "guest": { "can_run": False, "can_upload": False, "can_access_manager": False, "can_access_api": True, "can_see_restricted_settings": False, "can_have_api_tokens": False, "can_have_non_expiring_jwt": False },
        }
    return cfg
