...
def run_tests():
    ...
    ok(validate.validate_username("Default")[0] is False, "reserved 'Default' (case-insensitive) rejected")
    ok(validate.validate_username("DEFAULTS")[0] is False, "reserved 'DEFAULTS' (case-insensitive) rejected")
